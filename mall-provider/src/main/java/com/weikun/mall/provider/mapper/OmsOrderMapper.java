...
import com.weikun.api.model.OmsOrderExample;
import java.util.List;

import com.weikun.api.model.OmsOrderItem;
...
public interface OmsOrderMapper {
    ...
    @Results({
        ...
        @Result(property = "orderItemList",javaType = List.class,column="id",
                many = @Many(select="com.weikun.mall.provider.mapper.OmsOrderItemMapper.selectItemByOrderid")),
        @Result(property = "historyList",javaType = List.class,column="id",
                many = @Many(select="com.weikun.mall.provider.mapper.OmsOrderOperateHistoryMapper.selectHistoryByOrderId"))

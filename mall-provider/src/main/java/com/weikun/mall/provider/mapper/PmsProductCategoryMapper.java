...
import com.weikun.api.model.PmsProductCategoryExample;
...
public interface PmsProductCategoryMapper {
    ...
    @Results({
            ...
            @Result(property = "children",javaType = List.class,column="id",
                    many = @Many(select="com.weikun.mall.provider.mapper.PmsProductCategoryMapper.selectProductCategoryByParentId")
            )
    })
